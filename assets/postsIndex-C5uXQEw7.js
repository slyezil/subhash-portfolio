const e=[{slug:"building-agentflow",title:"Building AgentFlow: Bridging Spring Boot and Local LLMs with Context",date:"2026-02-08",tags:["Java","Spring Boot","LLM","Llama.cpp","AI"],description:"A deep dive into building a stateful conversational agent using Spring Boot and local Llama models with custom memory management.",readTime:"5 min read",file:"building-agentflow.md",content:`
